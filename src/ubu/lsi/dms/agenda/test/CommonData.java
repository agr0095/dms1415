...
/**
 * Vamos a almacenar en una clase los tipos que necesitemos para realizar
 * las pruebas que necesitamos en ambas clase, tanto en la fachada de BBDD
 * como en la fachada binaria.
 * 
 * @author killer7129
 *
 */
public class CommonData {
	...
	private CommonData(){		
		...
		for(int i=1; i<=50; i++){
			...
			Call call = new Call(i, contact, "FechaLlamada" + letra, "Asunto" + letra, "Notas" + letra);
